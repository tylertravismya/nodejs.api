...
define("TOKEN_VALIDATION_ERROR", "Unable to validate your token.");
...
define("REGISTER_MODEL_REQUEST_MSG", "Registering model %s on remote server.");
define("REGISTER_TECH_STACK_REQUEST_MSG", "Registering tech stack %s on remote server.");
