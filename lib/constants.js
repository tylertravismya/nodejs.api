...
define("VALIDATE_TECH_STACK_REQUEST_MSG", "Validating tech stack %s on realMethods Host.");
define("VALIDATE_MODEL_REQUEST_MSG", "Validating model %s on realMethods Host.");
define("REGISTER_MODEL_REQUEST_MSG", "Publishing model %s on realMethods Host.");
define("REGISTER_TECH_STACK_REQUEST_MSG", "Publishing tech stack %s on realMethods Host.");
define("REGISTER_RESOURCE_REQUEST_MSG", "Publishing resource %s on realMethods Host.");
define("GENERATE_APP_REQUEST_MSG", "Generating app %s on realMethods Host. Please wait...");
