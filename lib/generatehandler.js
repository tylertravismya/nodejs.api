	...
	generateAppHelper: (appParams, techStackId, modelId, appOptionsPath, gitParams) => {
		return new Promise(async function(resolve, reject) {
			...
			if ( appOptionsFileToUse == undefined) {
			    ...
			    // in the event a JAR/EAR file is being supplied as the model, need the Java Root Package Name
			    input.javaRootPackageName = appParams.model.javaRootPackageName;
